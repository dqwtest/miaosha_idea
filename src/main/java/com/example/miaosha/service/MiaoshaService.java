...
import com.example.miaosha.util.Snowflake;
...
public class MiaoshaService {
    ...
    @Transactional
    public OrderInfo miaosha(MiaoshaUser user, long goodsId) {
        // 判断库存
        // 添加行锁
    ...
    public long getMiaoshaResult(long userId, long goodsId) {
        MiaoshaOrder order = orderService.getMiaoshaOrderByUserIdGoods(userId, goodsId);
    ...
    public String createMiaoshaPath(MiaoshaUser user, long goodsId) {
        ...
        String str = String.valueOf(sf.nextId());
